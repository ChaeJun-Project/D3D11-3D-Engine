...
void Widget_Hierarchy::CreateSkyBox()
{
	if (auto scene = Hierarchy_Data::current_scene)
	{
		scene->CreateSkyBox();
...
void Widget_Hierarchy::CreateDirectionalLight()
{
	if (auto scene = Hierarchy_Data::current_scene)
	{
...
void Widget_Hierarchy::CreatePointLight()
{
	if (auto scene = Hierarchy_Data::current_scene)
	{
...
void Widget_Hierarchy::CreateSpotLight()
{
	if (auto scene = Hierarchy_Data::current_scene)
	{
