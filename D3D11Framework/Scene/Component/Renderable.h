...
public:
	...
	void SetMesh(const std::string& name, const std::vector<struct VertexTextureNormalTangentBlend>& vertices, const std::vector<uint>& indices, const D3D11_USAGE& usage = D3D11_USAGE_IMMUTABLE);
