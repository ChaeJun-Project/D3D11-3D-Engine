...
struct VertexTextureNormalTangentBlend final
{
	...
	VertexTextureNormalTangentBlend(const Vector3& position, const Vector2& uv)
		: position(position)
		, uv(uv)
		, normal(0.0f)
		, tangent(0.0f)
	...
	VertexTextureNormalTangentBlend(const Vector3& position, const Vector2& uv, const Vector3& normal, const Vector3& tangent, const Vector4& indices, const Vector4& weights)
		: position(position)
		, uv(uv)
		, normal(normal)
		, tangent(tangent)
